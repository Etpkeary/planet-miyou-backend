...
(
    ...
    maxNum      varchar(512)                       not null comment '最大人数',
    expireTime  datetime                           null comment '过期时间',
    userId      bigint                             null comment '创建队伍人id',
    status      int      default 0                 not null comment '房间状态 0 - 公开 1 - 加密',
    Password    varchar(512)                       not null comment '房间密码',
    createTime  datetime default CURRENT_TIMESTAMP null comment '创建时间',
